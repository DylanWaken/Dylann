...
namespace io {
    void printLogHead(LogLevel level, LogSegments segment){
        ...
        switch(segment){
            case LogSegments::LOG_SEG_MODEL:
                segName = dye::bright_white("model");
                break;
            case LogSegments::LOG_SEG_IO:
                segName = dye::white("io");
                break;
            case LogSegments::LOG_SEG_COMP:
                segName = dye::light_yellow("compute");
                break;
        }
